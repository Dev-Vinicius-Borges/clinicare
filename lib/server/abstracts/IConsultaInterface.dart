...
abstract class IConsultaInterface {
  Future<RespostaModel<ConsultaModel>> criarConsulta(CriarConsultaDto criarConsultaDto);
  ...
  Future<RespostaModel<ConsultaModel>> atualizarConsulta(AtualizarConsultaDto atualizarConsultaDto);
