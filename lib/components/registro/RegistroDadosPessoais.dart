...
class RegistroDadosPessoais extends StatelessWidget {
  const RegistroDadosPessoais({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  "Precisamos de apenas algumas informações para continuar.",
                  style: TextStyle(
              ...
              SizedBox(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: RegistroDadosPessoaisForm(),
                  ),
                ),
              ),
            ],
